"""
Django settings for site_dik23rus project.
...
SECRET_KEY = 'django-insecure-p80=f8_n(8ak&56xnp!-__0-rx%10cxn)wg9*s!sha7#-0547+'
...
WSGI_APPLICATION = 'site_dik23rus.wsgi.application'
